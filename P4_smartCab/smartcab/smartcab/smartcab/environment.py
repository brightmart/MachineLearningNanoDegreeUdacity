...
class TrafficLight(object):
    ...
    global countOfTotalSuccessfulTimes
    countOfTotalSuccessfulTimes=0
    ...
    def step(self):
        ...
        if self.primary_agent is not None:
            if self.enforce_deadline and self.agent_states[self.primary_agent]['deadline'] <= 0:
                self.done = True
                global countOfTotalSuccessfulTimes
                print "total successful:"+str(countOfTotalSuccessfulTimes)
    ...
    def act(self, agent, action):
        ...
        if agent is self.primary_agent:
            if state['location'] == state['destination']:
                ...
                self.done = True
                global countOfTotalSuccessfulTimes
                countOfTotalSuccessfulTimes=countOfTotalSuccessfulTimes+1
                print "total successful:"+str(countOfTotalSuccessfulTimes)
